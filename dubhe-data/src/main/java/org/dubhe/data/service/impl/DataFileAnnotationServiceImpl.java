...
public class DataFileAnnotationServiceImpl extends ServiceImpl<DataFileAnnotationMapper, DataFileAnnotation> implements DataFileAnnotationService {
     ...
     */
    @Override
    public List<DataFileAnnotation> getLabelIdByDatasetIdAndVersionId(List<Long> labelIdList, Long datasetId, Long offset, Integer limit,String versionName) {
        return baseMapper.getLabelIdByDatasetIdAndVersionId(labelIdList,datasetId,offset,limit, versionName);
    }
     ...
     */
    @Override
    public Long selectDetectionCount(Long datasetId, String versionName, List<Long> labelIdList) {
        return baseMapper.selectDetectionCount(datasetId, versionName, labelIdList);
    }
}
