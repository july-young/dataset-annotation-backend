...
public interface DataFileAnnotationService {
     ...
     */
    List<DataFileAnnotation> getLabelIdByDatasetIdAndVersionId(List<Long> labelId, Long datasetId, Long offset, Integer limit,String versionName);
     ...
     * @param labelId           标签id
     */
    Long selectDetectionCount(Long datasetId, String versionName, List<Long> labelId);
}
